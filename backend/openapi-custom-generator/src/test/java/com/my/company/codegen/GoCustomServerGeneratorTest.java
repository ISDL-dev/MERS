 ...
 * 1) Set a break point in GoCustomServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class GoCustomServerGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("go-custom-server") // use this codegen library
              ...
              .setOutputDir("out/go-custom-server"); // output directory
